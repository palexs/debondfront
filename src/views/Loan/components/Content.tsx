  ...
  render() {
    ...
    return (
      <div>
        ...
        <ApproveModal visible={this.state.approveModalStatus}
                      onSave={this.submit}
        ...
        <MyModal  visible={state.modalStatus} onCancel={this.handleModalStatus} spinning={this.state.spinning} refresh={this.refresh}  title="LOAN">
          <TradingInterface type="loan"
            ...
            <span className={`${buySashBond.proportion} ${buySashBond.block}`}>{ (this.state.stepSize / 100).toFixed(2) }%</span>
            <Input size="small"
