...
export class Content extends React.Component<IMyComponentProps, IMyComponentState> {
  ...
  public async init(provider: any) {
    ...
    var abi = require("../../../eigma-cash/deployments/SASHTOKEN.json");
    var abiRouter = require("../../../eigma-cash/deployments/uniswapRouter.json");
    var abiBank = require("../../../eigma-cash/deployments/bank.json");
    if (this.provider) {
      this.setState({
  ...
  public render() {
    var {totalSupply, currentPrice, mintingCost, disIsModal} = this.state;
    return (
      <div>
        ...
        <div>
         {/* <UnderConstructionModal visible={this.state.status} onCancel={this.handleBuySgmBondStatus} />*/}
          ...
          <BuySGMBond provider={this.provider} title={this.state.bondTitle} status={this.state.status} close={this.handleBuySgmBondStatus}
