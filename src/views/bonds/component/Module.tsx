...
export class Module extends React.Component<IMyComponentProps, IMyComponentState> {
    ...
    public order = async () => {
        ...
        var num = parseFloat(this.bondAmount) * 100000 + "0000000000000";
        objs["bondAmount"] = [BigNumber.from(num)];
        var ce = await this.contracts["dex"].addAuction(objs);
    }
            ...
            <div>
                <Modal title="Deposit for SASH" visible={this.props.disView} footer={null} onOk={this.props.openView} onCancel={this.props.closeView}>
                    <div style={{ marginLeft: " 9%" }}>
                        startingPrice:  <Input type="text" placeholder="(Number of inputs)" style={{ width: "300px", marginBottom: "10px", height: "35px" }} className={styles.amountNmuber} onBlur={this.setstartingPrice} />
                    </div>
                    <div style={{ marginLeft: " 9%" }}>
                        auctionTimestamp:  <Input type="text" placeholder="(Number of inputs)" style={{ width: "300px", marginBottom: "10px", height: "35px" }} className={styles.amountNmuber} onBlur={this.setauctionTimestamp} />
                    </div>
                    <div style={{ marginLeft: " 9%" }}>
                        auctionDuration:  <Input type="text" placeholder="(Number of inputs)" style={{ width: "300px", marginBottom: "10px", height: "35px" }} className={styles.amountNmuber} onBlur={this.setauctionDuration} />
                    </div>
                    <div style={{ marginLeft: " 9%" }}>
                        bondClass:  <Input type="text" placeholder="(Number of inputs)" style={{ width: "300px", marginBottom: "10px", height: "35px" }} className={styles.amountNmuber} onBlur={this.setbondClass} />
                    </div>
                    <div style={{ marginLeft: " 9%" }}>
                        bondNonce:  <Input type="text" placeholder="(Number of inputs)" style={{ width: "300px", marginBottom: "10px", height: "35px" }} className={styles.amountNmuber} onBlur={this.setbondNonce} />
                    </div>
                    <div style={{ marginLeft: " 9%" }}>
                        bondAmount:  <Input type="text" placeholder="(Number of inputs)" style={{ width: "300px", marginBottom: "10px", height: "35px" }} className={styles.amountNmuber} onBlur={this.setbondAmount} />
                    </div>
                    <div className={styles.disButton}>

                        <button className={styles.buttona} onClick={this.order}>Create Order</button></div>
