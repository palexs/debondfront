...
export class ContentModule extends React.Component<IMyComponentProps, IMyComponentState> {
    ...
    public bonds = async () => {
        ...
        var num = parseFloat(this.amount) * 100000 + "0000000000000";
            ...
            <div>
                <Modal title="Redeem Bonds" visible={this.props.disView} footer={null} onOk={this.props.openView} onCancel={this.props.closeView}>
                    <div style={{ marginLeft: " 9%" }}>
                        class:  <Input type="text" placeholder="(Number of inputs)" style={{ width: "300px", marginBottom: "10px", height: "35px" }} className={styles.amountNmuber} onBlur={this.setClass} />
                    </div>
                    <div style={{ marginLeft: " 9%" }}>
                        noice:  <Input type="text" placeholder="(Number of inputs)" style={{ width: "300px", marginBottom: "10px", height: "35px" }} className={styles.amountNmuber} onBlur={this.setNonice} />
                    </div>
                    <div style={{ marginLeft: " 9%" }}>
                    ...
                    <div className={styles.disButton}>
                        ...
                        <button className={styles.buttona} onClick={this.bonds}>Redeem Bonds</button></div>
