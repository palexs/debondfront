...
class Info extends Component {
  ...
  public generateItem = () => {
    ...
    return list.map((it, index) => (<div key={index} className={`${styles.content_item} content_item`}>
      <h4 className={styles.item_title}>{it.index}</h4> <p className="name">{it.name}</p> <p
      className="text">{it.text}</p>
    </div>))
  }
  /**
      ...
      <div className='info'>
        ...
        <section ref={this.ref.future} className={`${styles.future} future ${styles.center}`}>
          <div className={styles.title_wrap}>
            <h1 className={styles.title}>
              ...
              <span style={{textDecoration: "underline"}}>In the makin</span>g.
            </h1>
            ...
            }} className={`${styles.seeMore} seeMore`} type="link" ghost>SEE MORE <ArrowDownOutlined
              ref={this.ref.seeMore}/> </Button>
          </div>
        ...
        <section ref={this.ref.debond} className={`${styles.debond} ${styles.center}`}>
          ...
          <article className={styles.article}>
            <h3 dir="rtl" className={styles.title}>
              ...
              <small className={styles.sub_title}> Dcentralised Bond —</small> <br/>
              &lt;&gt;
            </h3>
            <div style={{color: "#fff"}} className={`${styles.debond_text} debond_text`}>
              ...
              <p >█████████████████████████████████████████████████████████</p>
              <p >
                <span className={styles.text}>Each bond corresponds to a specific loan agreement. </span>████████ <span className="xs-block">████</span>
              </p>
              <p >███████████████ <span
                className={styles.text}
                style={{textAlign: "right"}}>Turn any digital asset into a bond, in one click.</span></p>
              <p className="xs-hidden-flex">█████████████████<span>█████████</span>███████████████</p>
              <p className="xs-flex">█████████ <span>███████  </span>███████████████
              </p>
              <p >█████<span className={styles.text} style={{textAlign: "right"}}>Split and bundle bonds for trading in the secondary market.</span>
              </p>
              <p style={{
                display: "flex",
          ...
          <div className={styles.list}>
            ...
            <div className={styles.content}>
              <p className={`${styles.item} ecosystem_item`}>
                ...
                <span className={styles.lastName} onClick={(e) => {
        ...
        <section ref={this.ref.erc3475} className={`${styles.erc3475} ${styles.center}`}>
          <div className={styles.content}>
            ...
            <article className={styles.article}>
              <h3 dir="rtl" className={styles.title}>
                ERC-3475 <br/>
                Multiple <br className="xs-block"/> Callable <br className="xs-block"/> Bonds<br/>
                &lt;&gt;
              </h3>
              ...
              <div style={{textAlign: "right"}}>
                ...
                <Button className={styles.docBtn} type="default" ghost><span
                  className="xs-hidden" onClick={()=>{this.handleStatus()}} style={{marginRight:10}}>Developer</span> Documentation ⍈</Button>
                <p className={styles.eth} style={{fontSize: ".24rem", display: "flex", alignItems: 'center', flexDirection: "row-reverse"}}>
                  <a className={styles.eth} href="https://eips.ethereum.org/EIPS/eip-3475" target="_blank" style={{textDecoration: "underline",color:"#fff"}}>ETH Official Website</a><IconFont
                  type="icon-eth" className={styles.eth_icon}/>
                </p>
              </div>
        ...
        <section className={`${styles.standard} standard ${styles.center}`}>
          <div className={styles.top}>
            <div className={styles.content}>
              <h3 className={styles.title}>Debond <br/>
                Standard Maker</h3>
          ...
          <div className={styles.top}>
            ...
            <div dir="rtl" className={styles.content}>
              <h3 className={styles.title}>Low Access
                <br/>
                Threshold</h3>
          ...
          <div className={styles.top}>
            <div className={styles.content}>
              <h3 className={styles.title}>No-Hassle <br/>
                Endrsement</h3>
              <p className={styles.text}>
        ...
        <section className={`${styles.wallet} wallet ${styles.center}`}>
          <div ref={this.ref.wallet} className={styles.top}>
            <div className={`${styles.content} content`}>
              ...
              <ul className={styles.introduce}>
                ...
                <li className={styles.item}>There is no need for the users to download additional software or regenerate private keys. They can
                  access their ERC-3475 bonds by linking their existing wallet via metamask.
                </li>
              </ul>
              <Link className={`${styles.link}`} style={{border: 0}} to="/bonds"><Button size="large" type="default"
          ...
          <div ref={this.ref.dex} className={`${styles.top} ${styles.top_dex}`}>
            ...
            <div className={`${styles.content} content`}>
              ...
              <ul className={styles.introduce}>
                <li className={styles.item} >Due to the non-homogeneity of the DeBonds, transactions are done using Dutch auction.
                </li>
                <li className={styles.item}>
        ...
        <section className={`${styles.gov} ${styles.center}`}>
          <div>
            <h3 className={styles.title}>GOVERNANCE <span className={styles.title_small}>Decapital&lt;&gt;</span>
            </h3>
            <p className={styles.text}>A truly decentralised <br className="xs-block"/> governance platform</p>
            <div className={styles.top}>
              <div className={styles.content}>
                <Link className={`${styles.link}`} style={{border: 0}} to="/gov">
                  <Button style={{margin: 0}} size="large" type="default" className={styles.useApp} ghost>USE APP
                    ⍈</Button>
                </Link>
              </div>
