...
import {bar_styles} from "../../eigma-cash/format_util";
import {make_bar} from "../../eigma-cash/format_util";
      ...
      <MyModal title={'under construction... '} visible={this.props.visible} onCancel={this.props.onCancel}>
        <Row style={{padding:"0 20px"}}>
          <Col style={{textAlign:'center'}} span={24}>
            ...
            <p style={{marginBottom:100}}>{make_bar(36,bar_styles[8],7,this.state.maxsize).str} 36%</p>
          </Col>
        </Row>
        <Row>
          <Button style={{background:"#403af4 ",color:"#fff",borderColor:"#333",position:'absolute',right:20,bottom:20}} size={"large"} onClick={this.props.onCancel} type="default">Back</Button>
        </Row>
      </MyModal>
    )
  }
