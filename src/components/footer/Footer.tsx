...
export class Footers extends React.Component<IMyComponentProps, IMyComponentState> {
  ...
  public handleLink = () => {
    ...
    return list.map((item, i) => (<a href={item.link} target={item.target} onClick={(e) => {
    ...
    }} key={i} style={{margin: "10px auto", width: "fit-content", color: "#fff"}}>{item.name}</a>))
  }
  /**
        ...
        <div className={styles.footer}>
          <div className={styles.item1}>
            <div className={styles.item1_item}>
              <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 65 71"
                   width="100">
                <defs>
                ...
                <rect id="Picture2" width="65" height="71" fill="url(#pattern)"></rect>
              </svg>
            </div>
            <div className={styles.item1_item}>
            ...
            <div className={styles.item1_item}>
              ...
              <a className={styles.link} href="https://github.com/Sigmoid-Protocol/" target="_blank">Github</a>
              <a className={styles.link} href="https://eips.ethereum.org/EIPS/eip-3475" target="_blank">ERC-3475</a>
          ...
          <div className={styles.item2}>
            <div className={styles.item2_item}><a target="_blank" href=' https://twitter.com/ProtocolSigma'><img
              src={icon1}></img></a></div>
            <div className={styles.item2_item}><a target="_blank" href=' https://sigma-protocol.medium.com/'><img
              src={icon2}></img></a></div>
            <div className={styles.item2_item}><a target="_blank" onClick={this.handleStatus}><img
              src={icon3}></img></a></div>
            <div className={styles.item2_item}><a target="_blank" onClick={this.handleStatus}><img
              src={icon4}></img></a></div>
            <div className={styles.item2_item}><a target="_blank" href="https://github.com/Sigmoid-Protocol/"><img
              src={icon5}></img></a></div>
            <div className={styles.item2_item}><a target="_blank" href="https://t.me/sigma_protocol"><img
              src={icon6}></img></a></div>
            <div className={styles.item2_item}><a target="_blank" href="https://discord.gg/GYdhhMhV"><img
              src={icon7}></img></a></div>
          </div>
